...
def spawn_new_wizard():
    ...
    enemy = WizardEnemy(position=(4.5, ZONES[zone_system.zone_level] - 0.5, -1.5))
...
def attack():
    ...
    def on_hit():
        ...
        enemy.health_bar.value = max(0, enemy.health_bar.value - 25)
...
def blast():
    print("Torchy uses BLAST! (not implemented yet)")
    # You can copy logic from attack() to make a stronger animated attack
